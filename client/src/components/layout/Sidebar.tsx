...
const Sidebar: React.FC = () => {
  ...
  <ul className="absolute left-0 mt-2 w-72 bg-gray-300 text-gray-900 rounded-lg shadow-lg z-10 animate-fade-in">
    <li>
      <a href="/products/critical-care" className="flex items-center gap-3 px-6 py-3 hover:bg-blue-100 rounded-t-lg transition-colors duration-150">
        <HeartIcon className="h-5 w-5 text-red-500" />
        Critical Care Insurance
      </a>
    </li>
    <li>
      <a href="/products/hospital-daily-cash" className="flex items-center gap-3 px-6 py-1 hover:bg-blue-100 transition-colors duration-150">
        <CurrencyDollarIcon className="h-5 w-5 text-green-600" />
        Hospital Daily Cash Benefit Insurance
      </a>
    </li>
    <li>
      <a href="/products/vector-care" className="flex items-center gap-3 px-6 py-1 hover:bg-blue-100 transition-colors duration-150">
        <BugAntIcon className="h-5 w-5 text-purple-600" />
        Vector Care Insurance
      </a>
    </li>
    <li>
      <a href="/products/ambulance-service" className="flex items-center gap-3 px-6 py-1 hover:bg-blue-100 transition-colors duration-150">
        <TruckIcon className="h-5 w-5 text-blue-500" />
        Ambulance Service for Hospital Assistance Insurance
      </a>
    </li>
    <li>
      <a href="/products/family-health-protection" className="flex items-center gap-3 px-6 py-1 hover:bg-blue-100 transition-colors duration-150">
        <UsersIcon className="h-5 w-5 text-pink-600" />
        Family Health Protection Insurance
      </a>
    </li>
    <li>
      <a href="/products/senior-citizen-health" className="flex items-center gap-3 px-6 py-1 hover:bg-blue-100 transition-colors duration-150">
        <UserGroupIcon className="h-5 w-5 text-yellow-600" />
        Senior Citizen Health Cover Insurance
      </a>
    </li>
    <li>
      <a href="/products/maternity-child-care" className="flex items-center gap-3 px-6 py-1 hover:bg-blue-100 transition-colors duration-150">
        <GiftIcon className="h-5 w-5 text-pink-400" />
        Maternity & Child Care Insurance
      </a>
    </li>
    <li>
      <a href="/products/personal-accident" className="flex items-center gap-3 px-6 py-1 hover:bg-blue-100 transition-colors duration-150">
