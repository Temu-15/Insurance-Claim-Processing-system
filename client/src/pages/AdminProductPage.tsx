...
const AdminProductPage: React.FC = () => {
  ...
  const handleMultiInputChange = (
    type: "keyBenefits" | "coverages",
    idx: number,
    value: string
  ) => {
    setForm((prev) => ({
      ...prev,
      [type]: prev[type].map((item: string, i: number) =>
        i === idx ? value : item
      ),
    }));
  };
                ...
                <tbody>
                  {products.length === 0 ? (
                    ...
                    products.map((product) => (
                      ...
                      >
                        <td className="px-6 py-4 whitespace-nowrap text-[#099ab3] font-medium">
                          {product.productCode}
                        </td>
                          ...
                          product.keyBenefits.length > 0 ? (
                            <div className="flex flex-col gap-1">
                              <div>
                                {product.keyBenefits
                                  ...
                                  .map((benefit: string, idx: number) => (
                                    <span
                                      key={idx}
                                      className="inline-block bg-blue-100 text-blue-700 rounded-full px-2 py-0.5 text-xs font-medium mr-1 mb-1"
                                    >
                                      {benefit}
                                    </span>
                                  ))}
                              ...
                              <div>
                                ...
                                {product.keyBenefits.length > 4 && (
                                  <span className="inline-block bg-gray-200 text-gray-600 rounded-full px-2 py-0.5 text-xs font-medium mr-1 mb-1">
                                    +{product.keyBenefits.length - 4} more
                                  </span>
                                )}
                              </div>
                            </div>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          product.productId ? (
                            <Link
                              ...
                              className="bg-blue-100 text-blue-800 border border-blue-300 hover:bg-blue-200 hover:text-blue-900 text-xs font-semibold py-1 px-3 rounded transition-all duration-150"
                            >
                              See Details
                            </Link>
                          ) : (
                            <button
                              className="bg-gray-200 text-gray-400 border border-gray-300 text-xs font-semibold py-1 px-3 rounded cursor-not-allowed"
                              disabled
                              title="Product ID unavailable"
                            >
                              See Details
                            </button>
                          )}
          ...
          <section className="max-w-xl mx-auto bg-gradient-to-br from-blue-50 via-white to-indigo-100 p-8 rounded-2xl shadow-2xl border border-blue-100 mb-8 animate-fade-in">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label className="block font-semibold mb-1 text-blue-900 flex items-center gap-1">
                  ...
                  <span
                    ...
                    title="Unique identifier for the product"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M16 7a4 4 0 01-8 0m8 0a4 4 0 10-8 0m8 0V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m8 0a4 4 0 01-8 0"
                      />
                    </svg>
                  </span>
                </label>
              ...
              <div>
                ...
                />
                <span className="text-xs text-gray-400 ml-1">
                  Maximum amount covered by this product.
                </span>
              </div>
              <div>
                <label className="block font-semibold mb-1 text-blue-900 flex items-center gap-1">
                  ...
                  <span
                    className="text-blue-400"
                    title="Base cost for this product"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-4 w-4 inline"
              ...
              <div>
                <label className="block font-semibold mb-1 text-blue-900 flex items-center gap-1">
                  ...
                  <span
                    className="text-blue-400"
                    title="Short summary of the product"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-4 w-4 inline"
              ...
              <div>
                ...
                {form.keyBenefits.map((benefit: string, idx: number) => (
                  <div className="flex items-center gap-2 mb-2" key={idx}>
                    <input
                      ...
                      placeholder={
                        idx === 0 ? "e.g. Fast claims" : "Add another benefit"
                      }
                    />
                    {form.keyBenefits.length > 1 && (
                      <button
                        type="button"
                        onClick={() => handleRemoveField("keyBenefits", idx)}
                    ...
                    {idx === form.keyBenefits.length - 1 && (
                      <button
                        type="button"
                        onClick={() => handleAddField("keyBenefits")}
                ...
                <span className="text-xs text-gray-400 ml-1">
                  Add as many benefits as you like.
                </span>
              </div>
              <div>
                <label className="block font-semibold mb-1 text-blue-900 flex items-center gap-1">
                ...
                {form.coverages.map((coverage: string, idx: number) => (
                  <div className="flex items-center gap-2 mb-2" key={idx}>
                    <input
                      ...
                      value={coverage}
                      onChange={(e) =>
                        handleMultiInputChange("coverages", idx, e.target.value)
                      }
                      className="flex-1 border border-blue-200 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-400 bg-white/80 placeholder:text-blue-300 transition-shadow"
                      placeholder={
                        idx === 0
                    ...
                    {form.coverages.length > 1 && (
                      <button
                        type="button"
                        onClick={() => handleRemoveField("coverages", idx)}
                        className="text-red-500 hover:text-red-700 p-1"
                        title="Remove"
                      >
                        <svg
                    ...
                    {idx === form.coverages.length - 1 && (
                      <button
                        type="button"
                        onClick={() => handleAddField("coverages")}
                        className="text-blue-500 hover:text-blue-700 p-1"
                        title="Add"
                      >
                        <svg
                ...
                <span className="text-xs text-gray-400 ml-1">
                  Add as many coverages as you like.
                </span>
              </div>
              <div className="flex gap-4 pt-2">
                <button
                  type="submit"
                  className={`bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-lg shadow transition-all flex items-center justify-center ${
