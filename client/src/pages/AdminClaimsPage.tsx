          ...
          >
            ...
            >
              {claims
                ...
                >
                  <td className="py-3 px-6 text-[#154654] font-medium">
                    {claim.claimNumber}
                  </td>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
              <div>
                <div className="mb-3">
                  ...
                  <span className="text-gray-900">{viewClaim.claimNumber}</span>
                </div>
                <div className="mb-3">
                  <span className="font-semibold text-gray-700">
                    User Name:
                ...
                <div className="space-y-2 text-sm">
                  {(() => {
                    ...
                    const policy = policies.find((p) => {
                      return [p.policyId, p.id, p.policyNumber]
                        .map((x) => String(x))
                        .includes(claimPolicyId);
                    });
                    if (!policy)
                      return (
                        <div className="text-red-500">Policy not found</div>
                      );
                    return (
                      <>
                        <div>
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    setClaims((prev) =>
                      prev.filter((c) => c.claimId !== viewClaim.claimId)
                    );
                    setViewClaim(null);
                    await Swal.fire(
                      "Deleted!",
