    ...
    <section>
      <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[500px]">
        <div className="flex flex-col justify-center py-14 md:py-0 relative z-10">
          <div class="flex items-center bg-gray-200 space-x-2 px-2 py-1 rounded-full shadow-sm w-max">
            <span class="bg-[#547aff] text-white text-[14px] font-500 px-3 py-1 rounded-full">
              New
            </span>
          ...
          <div className="text-center md:text-left space-y-6 ">
            <h1 className="text-5xl lg:text-6xl font-bold text-[#000] leading-relaxed xl:leading-loose">
          ...
          <div className="flex justify-center gap-4 md:justify-start mt-10">
          ...
          <div className="flex jusitify-center items-center gap-4 my-4">
            <div class="flex -space-x-2">
              <img
                class="inline-block size-11 rounded-full ring-2 ring-white dark:ring-neutral-900"
